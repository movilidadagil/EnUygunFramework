...
public class FlightTicketRequest {
    ...
    Response response;
    public List<String> flightTicketFromList() throws UnirestException, IOException {
        HttpResponse<JsonNode> response = Unirest.get("https://www.enuygun.com/ucak-bileti/trip-autocomplete/?term=mer")
